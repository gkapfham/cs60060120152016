...
\begin{itemize}
  ...
  \item {\bf Class Participation}: This includes meeting regularly with your first reader. Although the exact details
    ...
    comments, to the Slack team used for this course.

  \item {\bf Course Repository}: This document must be approved by your senior thesis adviser and formatted according to the

  \item {\bf Written proposal}: This document must be approved by your senior thesis adviser and formatted according to the
  ...
  \item {\bf Proposal defense}: This event is scheduled in consultation with your first and second reader and the
    building coordinator, Pauline Lanzine.

  \item {\bf Thesis Chapters}: Any two chapters of your final senior thesis must be submitted to the course instructor
    by the aforementioned deadline.  The chapters must be formatted in the department's thesis style; please note that
