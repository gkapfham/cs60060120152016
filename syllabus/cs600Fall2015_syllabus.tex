...
\begin{itemize}
  ...
  \item Class Participation: This includes meeting regularly with your first reader. Although the exact details about
  frequency and length of each meeting must be established with your first reader, you should adhere to the previously
  stated schedule. Additionally, this also involves regular contributions, in the form of questions and comments, to the
  Slack team used for this course. \\[.1in]

\item Written proposal: This document must be approved by your senior thesis adviser and formatted according to the
department's thesis proposal style requirements, available from the course Web site. \\[.1in]

\item Proposal defense: This event is scheduled in consultation with your first and second reader and the building
coordinator, Pauline Lanzine. \\[.1in]

\item Chapters: Any two chapters of your final senior thesis must be submitted to the course instructor by the
